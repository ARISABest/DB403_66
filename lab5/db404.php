...
<body>
    ...
    <?php
        ...
        FROM customers 
        WHERE ContactTitle = 'Owner' 
        AND Country IN('Mexico','Spain','France') ORDER BY CompanyName DESC LIMIT 2";
        $result = $conn->query($sql);
        while ($row = $result->fetch_assoC()) {
            echo "<tr>
                    <td>{$row['CompanyName']}</td>
    ...
    ?>
        ...
        <li>
             ...
             <div>
            <code>
            SELECT Country, COUNT(*)AS member FROM customers WHERE Country='UK'OR Country='France' OR Country='Spain' GROUP BY Country;
            </code>
            <br>
            <table>
            <tr>
    ...
    <?php
        ...
        FROM customers 
        WHERE Country IN ('UK','France','Spain') GROUP BY Country;";
        $result = $conn->query($sql);
        while ($row = $result->fetch_assoC()) {
            echo "<tr>
                    <td>{$row['Country']}</td>
    ...
    ?>
        ...
        <li>
            ...
            <div>
            <code>
            SELECT Country, COUNT(*) member FROM customers WHERE Country IN ('UK','France','Spain') GROUP BY Country HAVING member >5 ORDER BY 2 DESC;
            </code>
            <br>
            <table>
            <tr>
    ...
    <?php
        $sql = "SELECT Country, COUNT(*)AS member 
        FROM customers 
        WHERE Country IN ('UK','France','Spain') GROUP BY Country HAVING member >5 ORDER BY 2 DESC;";
        $result = $conn->query($sql);
        while ($row = $result->fetch_assoC()) {
            echo "<tr>
                <td>{$row['Country']}</td>
    ...
    ?>
        ...
        <li>
            ...
            <div>
            <code>
            SELECT CategoryID, AVG(UnitPrice) avg_price FROM products GROUP BY CategoryID;
            </code>
            <br>
            <table>
            <tr>
